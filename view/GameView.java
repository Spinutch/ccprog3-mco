...
public class GameView {
     ...
     * 
     * @return user choice (1-6) or -1 if invalid
     */
     ...
     * 
     * @return the character name entered
     */
    ...
    /**
     * Displays races with bonuses and gets user selection
     * 
     * @param races list of available races
     * @return selected race index or -1 if invalid
     */
    ...
    /**
     * Displays class options and gets user selection
     * 
     * @return selected class name or null if invalid
     */
    ...
    /**
     * Displays abilities and gets user selections
     * 
     * @param abilities     list of available abilities
     * @param maxSelections maximum number to select
    ...
    /**
     * Displays characters and prompts user to select one
     * 
     * @param characters list of characters to choose from
     * @return selected character index or -1 if invalid
     */
    ...
    /**
     * Prompts user to select two characters for battle
     * 
     * @param characters list of available characters
     * @return array with two character indices or null if invalid
     */
